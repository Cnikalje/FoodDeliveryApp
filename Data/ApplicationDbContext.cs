    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer>().HasData(
                new Customer { CustomerId = 1, CustomerName = "John Doe", Email = "john@example.com", Password = "john@123", PhoneNumber = "9876543210", City = "123 Main Street" },
                new Customer { CustomerId = 2, CustomerName = "Jane Smith", Email = "jane@example.com", Password = "jane@123", PhoneNumber = "5554443322", City = "456 South Avenue" }
            );
